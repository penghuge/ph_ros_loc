...
//计算起点与终点的相对位姿，将该位姿与relative_pose做差，得到残差
template <typename T>
...
//在所有支持的平台上，Eigen中四元组插值的实现与Ceres不兼容。只能使用自己的实现。
template <typename T>

...
//用于从磁盘读取文件的“LuaParameterDictionary”的“FileResolver”。
//它搜索' configuration_files_directory '以查找请求的文件名。
//搜索的最后一个位置总是安装了Cartographer的'configuration_files/'目录。
//它包含各种Cartographer组件的合理配置，为新平台提供了良好的起点。

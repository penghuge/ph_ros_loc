...
#ifndef CARTO_MAPPING_BRIDGE_NODE_OPTIONS_H
#define CARTO_MAPPING_BRIDGE_NODE_OPTIONS_H
...
// Top-level options of Cartographer integration.
struct NodeOptions {
...
#endif  // CARTO_MAPPING_BRIDGE_NODE_OPTIONS_H

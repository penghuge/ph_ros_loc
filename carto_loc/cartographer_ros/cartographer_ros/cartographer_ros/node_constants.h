...
constexpr char kAssignedSubmapIdTopic[] = "assigned_submap";
constexpr char kSetCartoInitPoseServiceName[] = "set_carto_initpose";
constexpr char kUsingPredictPoseServiceName[] = "using_predict_pose";
constexpr char kRefInSubmapQueryServiceName[] = "ref_in_submap_query";
